...
public class DietaHipertrofia extends Dieta {
	...
	public DietaHipertrofia (String nome, int duracao, String refeicao1,String refeicao2, String refeicao3, String refeicao4,String descricao)
{
   super("DietaHipertrofia",
		  8,
